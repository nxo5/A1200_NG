...
-- Funktion: Der übergeordnete ALU-Decoder-Wrapper des 68EC030.
...
entity cpu_030_ec_dec_alu is
    Port (
        ...
        alu_dec_en      : in    std_logic;                      -- Freigabe dieses Decoders
        ...
        dec_alu_size    : out   std_logic_vector(1 downto 0);   -- Operationsbreite (00=B, 01=W, 10=L)
        dec_alu_bus_req : out   std_logic;                      -- Bus-Zyklus anfordern
        dec_alu_bus_w   : out   std_logic;                      -- '1' = Schreiben, '0' = Lesen
        
        -- Schnittstelle zum Rechenwerk (ALU)
        dec_alu_op      : out   std_logic_vector(7 downto 0);   -- Operations-ID für das Rechenwerk
        dec_alu_src_reg : out   std_logic_vector(3 downto 0);   -- Quellregister-Auswahl
        dec_alu_dst_reg : out   std_logic_vector(3 downto 0);   -- Zielregister-Auswahl
        dec_alu_ready   : out   std_logic                       -- Befehl komplett fertig ausgeführt
    );
end cpu_030_ec_dec_alu;

architecture structural of cpu_030_ec_dec_alu is

    -- =====================================================================
    -- KOMPONENTENDEKLARATIONEN DER NEUEN UNTERMODULE
    -- =====================================================================
    component cpu_030_ec_dec_alu_op
        Port (
    ...
    component cpu_030_ec_dec_alu_size
        Port (
            opcode          : in    std_logic_vector(15 downto 0);
            alu_dec_en      : in    std_logic;
...
begin
    ...
    dec_alu_size <= sub_size;

    -- =====================================================================
    -- INSTANZIIERUNG: Der kombinatorische Opcode-Klassifizierer
    -- =====================================================================
    i_alu_op_decoder : cpu_030_ec_dec_alu_op
        port map (
            opcode          => opcode,
            alu_dec_en      => alu_dec_en,
            ea_calc_start   => ea_calc_start,
            ea_mode         => ea_mode,
            ea_reg          => ea_reg,
            dec_alu_bus_req => sub_bus_req,
            dec_alu_bus_w   => sub_bus_w,
            dec_alu_op      => sub_alu_op,
            dec_alu_src_reg => sub_src_reg,
            dec_alu_dst_reg => sub_dst_reg
        );

    -- =====================================================================
    -- INSTANZIIERUNG: Die kombinatorische Größen-Extraktion
    -- =====================================================================
    i_alu_size_decoder : cpu_030_ec_dec_alu_size
        port map (
            opcode          => opcode,
            alu_dec_en      => alu_dec_en,
            dec_alu_size    => sub_size

-- =========================================================================
-- Projekt: A1200_NG
-- Datei:   cia_a_timer.vhd
-- Teil:    1 von 2 (Schnittstelle & Register-Deklarationen)
-- Funktion: Das Zeitmessgetriebe des Complex Interface Adapters A (CIA-A).
--           Verwaltet die 16-Bit-Intervalltimer A und B mit Latch-Nachladung.
-- IMPLEMENTIERUNG SCHRITT 2 (A):
--   - Native 16-Bit Timer-Struktur (TA_LO=$4, TA_HI=$5, TB_LO=$6, TB_HI=$7).
--   - Kontrollregister CRA ($E) und CRB ($F) für Modus-Auswertungen.
-- =========================================================================

...
entity cia_a is
    Port (
        ...
        -- =============================================================
        cia_data      : inout std_logic_vector(7 downto 0); -- Wird an D24-D31 gelötet
        ...
        cia_irq_n     : out   std_logic;                     -- Interrupt-Ausgang
        ...
        cia_cnt       : inout std_logic;                    -- Counter-Pin (Keyboard Clock)
        cia_sp        : inout std_logic                     -- Serial Port Pin (Keyboard Data)
    );
end cia_a;

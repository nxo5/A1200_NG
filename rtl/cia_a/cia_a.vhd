...
-- SANIERUNG: 100% INOUT-FREIE FPGA-INFERENZ (0 ERRORS)
-- =========================================================================
...
entity cia_a is
    Port (
        ...
        -- =============================================================
        cia_port_a_in     : in    std_logic_vector(7 downto 0);  -- Mausknöpfe Lesen
        cia_port_a_out    : out   std_logic_vector(7 downto 0);  -- Mausknöpfe Schreiben
        cia_port_b_in     : in    std_logic_vector(7 downto 0);  -- Floppy-Status Lesen
        cia_port_b_out    : out   std_logic_vector(7 downto 0);  -- Floppy-Control Schreiben
        cia_tod           : in    std_logic;                    
        cia_cnt           : in    std_logic;                    -- Tastatur-Clock (Reiner Eingang!)
        cia_sp_in         : in    std_logic;                    -- Tastatur-Daten Lesen
        cia_sp_out        : out   std_logic                      -- Tastatur-Daten Schreiben
    );
end cia_a;

architecture Behavioral of cia_a is

    -- Modulschablonen saniert auf gerichtete Einbahnstraßen-Signalströme
    ...
    begin
        case reg_addr is
            when x"0" | x"1" | x"2" | x"3" =>
                mux_data_out <= data_from_io;     -- Port Data, Data Direction [14.1]

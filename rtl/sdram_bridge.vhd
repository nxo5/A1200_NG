...
-- Teil:    1 von 3 (Die echte, unidirektionale Gatter-Schnittstelle)
...
--   - Ersetzt es durch getrennte am_data_in und am_data_out Lanes. [14.1]
--   - Bringt die Brücke in 100%ige Übereinstimmung mit Ihrem Top-Level. [14.1]
-- =========================================================================
...
entity sdram_bridge is
    Port (
        ...
        -- HIER ABSOLUT TRI-STATE-FREI ENTFLECHTET: [14.1]
        am_data_in      : in    std_logic_vector(31 downto 0); -- Schreibdaten VON der CPU [14.1]
        am_data_out     : out   std_logic_vector(31 downto 0); -- Lesedaten ZUR CPU [14.1]
        ...
        sdram_data      : inout std_logic_vector(15 downto 0); -- Hier erlaubt (Echte physische I/O Pins!)
...
begin
    ...
    -- Verhindert Geisterpegel und tilgt Error 13066 restlos aus dem Fitter. [14.1]
    -- =====================================================================
    ...
    begin
        ...
        if current_state = SD_CMD_1 or current_state = SD_CMD_2 then
	     ...
	     -- =====================================================================
    -- 4. CENTRAL 114-MHZ SIZING- AND COMMAND-FSM WITH INTEGRATED BYPASS
    -- =====================================================================
                ...
                when SD_IDLE =>
                    ...
                    if i_ks_download = '1' then
                        ...
                        if as_n_r2 = '0' and dec_sb_req = '1' then
                            ...
                            -- KORREKTUR: Liest absolut richtungskonform vom reinen Eingangsport! [14.1]
